...
function ButtonList(props){
  ...
  <Link className="value" style={{textDecoration: 'none'}} to='/bestrated' onClick={() => props.editFilter('maxR')}>
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-star-fill svgIcon" viewBox="0 0 16 16">
  ...
  <Link className="value" style={{textDecoration: 'none'}} to='/seenlastmonth' onClick={() => props.editFilter('lastMonth')}> 
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-clock-history svgIcon" viewBox="0 0 16 16">
