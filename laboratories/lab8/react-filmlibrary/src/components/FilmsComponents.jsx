        ...
        <>
            ...
            <Row>
              <Col lg={10} className="mx-auto">
                <FilmsTable films={filteredMovies} handleEdit={props.handleEdit} updateMovie={props.updateMovie} deleteMovie={props.deleteMovie}></FilmsTable>
              </Col>
            </Row>
            <Link className='btn floating-button rounded-circle' onClick={()=>setMode('add')} to='../add'><i className="bi bi-plus text-light"/></Link>
      </>
    );
}
...
function FilmsTable (props) {
    ...
    return (
        <Table hover >
            <tbody>
                { props.films.map((movie) => <FilmRow film={movie} key={movie.id} handleEdit={props.handleEdit} updateMovie={props.updateMovie} deleteMovie={props.deleteMovie}/>)}
            </tbody>
        </Table>
    );
}
...
function FilmRow (props) {
    return(
        <tr style={{marginTop: '4px'}}><FilmData film={props.film} handleEdit={props.handleEdit} updateMovie={props.updateMovie} deleteMovie={props.deleteMovie}/></tr>
      );
}
...
function FilmData (props) {
    ...
    <>
      ...
      <FilmAction handleEdit={props.handleEdit} film={props.film} deleteMovie={props.deleteMovie}/>
    </>
    );
}
