...
function ButtonList(props){
  ...
  <Link className="value" style={{textDecoration: 'none'}} to='/' onClick={() => props.editFilter('All')}>
  ...
  <Link className="value" style={{textDecoration: 'none'}} to='/favorites' onClick={() => props.editFilter('favorites')}>
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-heart-fill svgIcon" viewBox="0 0 16 16">
      <path fill="#FBFBFB"  d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/>
    </svg>
    Favorites
  </Link>
  <Link className="value" style={{textDecoration: 'none'}} to='/bestrated' onClick={() => props.editFilter('bestrated')}>
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-star-fill svgIcon" viewBox="0 0 16 16">
  ...
  <Link className="value" style={{textDecoration: 'none'}} to='/seenlastmonth' onClick={() => props.editFilter('seenlastmonth')}> 
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-clock-history svgIcon" viewBox="0 0 16 16">
  ...
  <Link className="value" style={{textDecoration: 'none'}} to='/unseen' onClick={() => props.editFilter('unseen')}>
    <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-eye-slash-fill svgIcon" viewBox="0 0 16 16">
