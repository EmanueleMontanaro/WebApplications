...
function AnswerForm(props) {
  ...
  const handleSubmit = (event) => {
    ...
    if(props.mode === 'edit') {
      ...
      navigate('../..', {relative: "path"}); {/* Anche qui abbiamo un redirect una volta che il form di edit o di add vengono submittati */}
    } else {
  ...
  return(
    <Form onSubmit={handleSubmit}>
      ...
      <Link className='btn btn-danger mx-2 my-2' to={props.answer ? '../..':'..'} relative='path'>Cancel</Link> { /* Il primo caso è per tornare alla root, il secondo è per tornare indietro di una pagina, ma bisogna specificare relative='path' */ }
    </Form>
  );
}
